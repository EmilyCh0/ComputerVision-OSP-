...
int main() {
	...
	Mat input = imread("input.jpg", cv::IMREAD_COLOR);	// changed due to different version
	Mat input_gray;		// output
	cvtColor(input, input_gray, cv::COLOR_RGB2GRAY);	// changed due to different version
